  ...
  <div class="fc-style">
    <el-container class="fc-container">
      <el-main class="fc-main">
        <el-container>
          <el-aside class="form-d-card" width="250px">
          ...
          <el-main class="form-d-card center-container">
            <ElCustomHeader
              v-bind="$props"
          ...
          <el-aside class="form-d-card widget-config-container" width="400px">
            <el-container>
              <el-header>
                <div
                  class="config-tab"
...
import ElGenerateForm from '@/components/ElGeneratorForm/index.vue'
